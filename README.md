...
* [Architecture Decision Records (ADR)](./docs/adr/) - Detailed technical choices and rationale
* [Caching Strategy](./docs/CACHING_STRATEGY.md) - Redis caching patterns and invalidation
* [API Versioning](./docs/API_VERSIONING.md) - API versioning strategy and deprecation policy
* [Security & Compliance](./docs/SECURITY.md) - OWASP Top 10, GDPR compliance
* [Package Licenses](./docs/PACKAGE_LICENSES.md) - Third-party package licenses and legal considerations
...
* **Performance**: Engineered for a sub-150ms (P95) latency target, with Redis caching for drafts, Hangfire for reliable background job processing, and Dapper for optimized read queries.
